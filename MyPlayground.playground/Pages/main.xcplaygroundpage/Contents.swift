...
func isForceWith(name:String) -> Bool {
    if(name == "Luke" || name == "Leia" || name == "Anakin" || name == "Obi Wan" || name == "Yoda" || name == "Yoda"){
        return true
    } else {
        return false
    }
...
*/
func bankAccounts(myAccount:Double, anotherAccount:Double){
    if(anotherAccount - 10.0 >= 0){
        let myAccountUpdated = myAccount + 10;
        let anotherAccountUpdated = myAccount - 10;
    }
}
